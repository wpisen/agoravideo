...
public class SignUtil {
     ...
     * @throws Exception
     */
    public static String appSign(String appId, String secretId, String secretKey, String bucketName,
            long expired) throws Exception {
        long now = System.currentTimeMillis() / 1000;
        int rdm = Math.abs(new Random().nextInt());
        String plainText = String.format("a=%s&b=%s&k=%s&t=%d&e=%d&r=%d", appId, bucketName,
